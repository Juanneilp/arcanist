...
function envryptEncrypt(value, key) {
  return Buffer.from(
...
function envryptDecrypt(value, key) {
...
function loadEnv({ envPath = DEFAULT_ENV_PATH, keyPath = DEFAULT_KEY_PATH, override = true } = {}) {
