...
async function runBot() {
    ...
    const botConfig = userConfig.meteoraConfig || { maxSolPerPosition: 0.15, minSolToOpen: 0.21, gasReserve: 0.1, refundableReserve: 0.05, minBinStep: 80, maxBinStep: 125, minFee: 0.1, maxFee: 2.0, minRange: 86, maxRange: 94, strategyType: 0 };
